...
--
-- Table structure for table `studentmasterbyterminal`
--

DROP TABLE IF EXISTS `studentmasterbyterminal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `studentmasterbyterminal` (
  `id` int NOT NULL,
...
--
-- Dumping data for table `studentmasterbyterminal`
--

LOCK TABLES `studentmasterbyterminal` WRITE;
/*!40000 ALTER TABLE `studentmasterbyterminal` DISABLE KEYS */;
/*!40000 ALTER TABLE `studentmasterbyterminal` ENABLE KEYS */;
UNLOCK TABLES;
