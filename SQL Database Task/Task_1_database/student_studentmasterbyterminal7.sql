...
--
-- Table structure for table `studentmasterbyterminal7`
--

DROP TABLE IF EXISTS `studentmasterbyterminal7`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `studentmasterbyterminal7` (
...
--
-- Dumping data for table `studentmasterbyterminal7`
--

LOCK TABLES `studentmasterbyterminal7` WRITE;
/*!40000 ALTER TABLE `studentmasterbyterminal7` DISABLE KEYS */;
/*!40000 ALTER TABLE `studentmasterbyterminal7` ENABLE KEYS */;
UNLOCK TABLES;
