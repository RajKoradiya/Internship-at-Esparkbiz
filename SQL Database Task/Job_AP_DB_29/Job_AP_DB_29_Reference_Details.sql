...
CREATE TABLE `Reference_Details` (
  ...
  KEY `c_id` (`c_id`),
  CONSTRAINT `Reference_Details_ibfk_1` FOREIGN KEY (`c_id`) REFERENCES `CandidateMaster` (`c_id`)
