const connection = require("../config/databaseCon");
...
exports.fieldData = async (req,res)=>{
    try {
        ...
        let totalPage = Math.floor(dataCount[0].count / process.env.TOTALVALUE);
        let page;
        ...
        if(!(fname === "" || lname === "" || city === "" || operator === "")){ 
            ...
            // console.log(result);
            res.render('filterData', {data:result, page:page, totalpage:totalPage, path:req.pathname, fname:fname, lname:lname, city:city, operator:operator})
        }
